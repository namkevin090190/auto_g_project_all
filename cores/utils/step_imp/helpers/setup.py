...
from cores.utils import SwaggerUtil, BaseTestLink, TestPlan, Build, TimeUtil
from cores.utils.logger_util import logger
from cores.const.common import EnvironmentConst as const, CommonTypeUsageConst, TestlinkMsgConst, TimeConst


class CommonUsage:

    @staticmethod
    def __generate_token(env: str, user_type: str, flag: bool, token_url: str, url: str, swagger_url: str,
                         project_name: str):
