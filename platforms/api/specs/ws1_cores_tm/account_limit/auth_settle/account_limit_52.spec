# [FullKYC] Verify user make authorisation FAIL without Per transaction limit - foreign card
Tags: ws1, ws1_account_limit, account_limit_52
...
* [API][PostingInstruction] Get balance and info of "current_account_id", then Authorisation at time stamp "current_time_stamp" with data - amount "50000001" - account id "current_account_id" - transaction code "VIRTUAL_CARD_FX_CARD_NOT_PRESENT,CARD,CASA"
