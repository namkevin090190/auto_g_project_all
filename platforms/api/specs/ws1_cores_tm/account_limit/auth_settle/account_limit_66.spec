...
Tags: ws1, ws1_account_limit, account_limit_66
...
* [API][PostingInstruction] Get balance and info of "current_account_id", then Settlement at time stamp "current_time_stamp" with data - amount "30000000" - account id "current_account_id" - transaction code "VIRTUAL_CARD_FX_CARD_NOT_PRESENT,CARD,CASA" - client transaction id order "1"
