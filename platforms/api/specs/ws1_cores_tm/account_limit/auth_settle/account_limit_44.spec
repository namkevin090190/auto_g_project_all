# [eKYC] Verify user make authorisation FAIL - foreign card
Tags: ws1, ws1_account_limit, account_limit_44
...
* [API][PostingInstruction] Get balance and info of "current_account_id", then Authorisation at time stamp "current_time_stamp" with data - amount "1" - account id "current_account_id" - transaction code "VIRTUAL_CARD_FX_CARD_NOT_PRESENT,CARD,CASA"
