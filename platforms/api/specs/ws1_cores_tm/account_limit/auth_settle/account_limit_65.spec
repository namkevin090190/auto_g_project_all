# [eKYC] Verify user make authorisation and release successfully
Tags: ws1, ws1_account_limit, account_limit_65
...
* [API][PostingInstruction] Get balance and info of "current_account_id" at pause time "2023-10-27T01:30:00Z", then Release at time stamp "2023-10-27T01:35:00Z" with data - account id "current_account_id" - transaction code "VIRTUAL_CARD_CARD_NOT_PRESENT,CARD,CASA" - client transaction id order "1"
* [API][PostingInstruction] Verify status of posting id "current_posting_id" should be "POSTING_INSTRUCTION_BATCH_STATUS_ACCEPTED"
* [API][PostingInstruction] Verify Instruction Detail posting id "current_posting_id" should match with "VIRTUAL_CARD_CARD_NOT_PRESENT,CARD,CASA"
...
* [API][CASA] Verify account "EKYC" - monthly limit of CASA account with id "current_account_id" at pause time "2023-10-27T01:40:00Z" should be correct after making release - client transaction id order "1" - "fail", "success", "success"