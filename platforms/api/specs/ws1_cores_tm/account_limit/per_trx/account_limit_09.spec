# [FullKYC] [FullKYC] Verify user make transaction FAIL without Per transaction limit - domestic card
Tags: ws1, ws1_account_limit, account_limit_09
...
* [API][PostingInstruction] Get balance and info of "current_account_id", then Outbound Hard Settlement at time stamp "current_time_stamp" with data - amount "50000001" - account id "current_account_id" - transaction code "VIRTUAL_CARD_CARD_NOT_PRESENT,CARD,CASA"
