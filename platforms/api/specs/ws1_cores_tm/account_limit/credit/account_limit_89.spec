# [eKYC] Verify user is credit (cash in) successfully with Inbound and Daily/Monthly limit
Tags: ws1, ws1_account_limit, account_limit_89
...
* [API][PostingInstruction] Get balance and info of "current_account_id", then Inbound Hard Settlement at time stamp "current_time_stamp" with data - amount "9999999" - account id "current_account_id" - transaction code "VIKKI_TO_VIKKI,INTERNAL_TRANSFER,E_BANKING,CASA"
...
* [API][PostingInstruction] Get balance and info of "current_account_id", then Inbound Hard Settlement at time stamp "current_time_stamp" with data - amount "10000000" - account id "current_account_id" - transaction code "VIKKI_TO_HDBANK,INTERNAL_TRANSFER,E_BANKING,CASA"
* [API][PostingInstruction] Verify status of posting id "current_posting_id" should be "POSTING_INSTRUCTION_BATCH_STATUS_ACCEPTED"
...
* [API][PostingInstruction] Get balance and info of "current_account_id", then Inbound Hard Settlement at time stamp "current_time_stamp" with data - amount "10000001" - account id "current_account_id" - transaction code "VIKKI_TO_NAPAS,E_BANKING,CASA"
* [API][PostingInstruction] Verify status of posting id "current_posting_id" should be "POSTING_INSTRUCTION_BATCH_STATUS_ACCEPTED"
